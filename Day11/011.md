...
9. Test you can access using `curl http://stapp02:8080`. Now lets modify the port and deploy ROOT.war

10. To modify the port edit the `/opt/tomcat/conf/server.xml` and change port 8080 to 8084
...
13. Unzip the ROOT.war
    ...
    ```sh
    unzip /home/steve/ROOT.war -d /opt/tomcat/webapps/ROOT
    ```
